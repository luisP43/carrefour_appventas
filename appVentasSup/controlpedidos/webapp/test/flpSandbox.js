		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DEPARTAMENTO DE VENTAS - CONTROL DE PEDIDOS",
									"targetURL": "#carrefourcontrolpedidos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"carrefourcontrolpedidos-display": {
								"semanticObject": "carrefourcontrolpedidos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=carrefour.controlpedidos",
									"url": sap.ui.require.toUrl("carrefour/controlpedidos")
								}
							}
						}
					}
